...
CREATE TABLE Walmart (
    ...
    Branch VARCHAR(50),        -- Branch information (e.g., branch code or name)
    City VARCHAR(50),          -- City where the branch is located
    category VARCHAR(50),      -- Product or service category
    unit_price DECIMAL(10, 2), -- Price per unit of the product/service
    quantity INT,              -- Quantity purchased
    date DATE,                 -- Date of the transaction
    time TIME,                 -- Time of the transaction
    payment_method VARCHAR(50),-- Payment method used (e.g., cash, credit card)
    rating DECIMAL(3, 1),      -- Customer rating (e.g., scale of 1 to 5)
